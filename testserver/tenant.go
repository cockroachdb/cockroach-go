...
// This functionality is experimental and subject to change. To use it, a caller
// must first define an interface that includes NewTenantServer, and
// subsequently cast the TestServer obtained from NewTestServer to this
// interface. Refer to the tests for an example.
// WARNING: This functionality is experimental and subject to change. The
// cockroach mt start-sql command has more information.
